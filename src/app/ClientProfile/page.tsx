    ...
    <div className="min-h-screen w-full flex flex-col items-start bg-white">
      ...
      <div className="w-5/6 mx-auto mt-4 sm:mt-8 md:mt-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-4 py-2">
          {/* Box 1 */}
          <div className="w-full lg:w-3/7 bg-white p-2 sm:p-4 rounded-lg shadow-md border border-gray-300 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center mt-1 w-full sm:w-5/6 h-8 sm:h-10">
              <p className="text-md sm:text-lg text-black font-bold mr-0 sm:mr-2">
                Wedding (Oct 1, 2025)
              </p>
              <button className="px-2 sm:px-3 py-1 sm:py-1 bg-[#01B0E9] text-white text-sm sm:text-base rounded-full">
                PROPOSAL
              </button>
            </div>
            <div className="w-full flex flex-row justify-center items-center border-b border-gray-300">
              <div className="flex justify-between space-x-2 sm:space-x-4 py-2 sm:py-7 w-full sm:w-5/10">
                <span className="w-8 sm:w-10 h-8 sm:h-10 bg-yellow-400 rounded-full flex items-center justify-center">
                  <img
                    src="/mail_outline.png"
                    alt="Mail"
                    className="w-4 sm:w-6 h-3 sm:h-4 object-center"
                  />
                </span>
                <span className="w-8 sm:w-10 h-8 sm:h-10 bg-blue-500 rounded-full flex items-center justify-center">
                  <img
                    src="/phone_outline.png"
                    alt="Phone"
                    className="w-3 sm:w-5 h-3 sm:h-4 object-center"
                  />
                </span>
                <span className="w-8 sm:w-10 h-8 sm:h-10 bg-green-500 rounded-full flex items-center justify-center">
                  <img
                    src="/team.png"
                    alt="Team"
                    className="w-4 sm:w-6 h-3 sm:h-4 object-center"
              ...
              <div className="flex items-center mt-2 sm:mt-4">
                <span className="w-7 sm:w-9 h-7 sm:h-9 border-2 border-[#D4D4D8] bg-[#F4F4F5] rounded-full flex items-center justify-center mr-2 sm:mr-3">
                  <img
                    src="/mail_outline.png"
                    alt="Email"
                    className="w-3 sm:w-4 h-3 sm:h-4 object-center"
                  />
                </span>
                <div>
