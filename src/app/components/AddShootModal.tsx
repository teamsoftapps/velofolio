...
export default function AddShootModal({
    ...
    return (
        <>
            ...
            <div className="fixed inset-0 flex top-16  items-center justify-center z-50 p-4">
                <div className="bg-white rounded-md shadow-xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
