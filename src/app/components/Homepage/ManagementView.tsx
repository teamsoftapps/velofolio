...
const ManagementView = () => {
  return (
    <div className='w-full items-center text-black text-center'>
        <h1 className='text-3xl sm:text-5xl text-center mb-2'>Experience Our Studio <br /> Management <span className='text-[var(--primary-color)] leading-tight'> Anywhere</span> </h1>
