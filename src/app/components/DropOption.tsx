...
const DropOption = ({options}:any) => {
  return (
        <div className="relative w-full sm:w-48">
              <select
                className="w-full appearance-none rounded-md border border-gray-300 bg-gray-200 py-2 pl-3 pr-10 text-sm focus:border-[#01B0E9] focus:outline-none focus:ring-2 focus:ring-[#01B0E9]/20 sm:text-sm"
