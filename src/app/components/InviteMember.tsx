...
import { MdClose, MdEmail, MdPerson, MdCheck } from 'react-icons/md';
...
const roles = ['Designer', 'Developer', 'Project Manager', 'Editor', 'Viewer'];
...
export default function InviteMemberModal({ isOpen, onClose }: InviteMemberModalProps) {
  ...
  return (
    <>
      ...
      {/* Modal */}
      <div className="absolute -bottom-64 sm:bottom-0 left-0 sm:-left-80 z-50  flex items-center justify-center p-3 py-4">
