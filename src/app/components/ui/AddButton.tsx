...
const AddButton = ({
  ...
  return (
    <button
      ...
      className="flex items-center gap-3 h-11 pl-1.5 pr-6 bg-[var(--primary-color)] rounded-full text-sm font-bold text-white hover:brightness-105 transition-all cursor-pointer whitespace-nowrap w-fit ml-auto"
    >
