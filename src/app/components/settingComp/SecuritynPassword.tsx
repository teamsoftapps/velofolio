...
// <TwoFactorAuthCard setIsOpenTFAModal={setOpenTwoFactorModal} setDisable2FAModal={setDisable2FAModal} openDisable2FAModal={openDisable2FAModal}/>
// <ActiveSessionsCard/>

//                 </div>
      
// {openTwoFactorModal && <TwoFactorSetupModal setIsOpenTFAModal={setOpenTwoFactorModal}  />}
// {openDisable2FAModal && <Disable2FAModal setIsOpen={setDisable2FAModal}  isOpen={openDisable2FAModal}/>}
...
const SecuritynPassword = () => {
  const [openTwoFactorModal, setOpenTwoFactorModal] = useState(false);
  const [openDisable2FAModal, setDisable2FAModal] = useState(false);
  const [is2FAEnabled, setIs2FAEnabled] = useState(false); // single source of truth
