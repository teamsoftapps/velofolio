    ...
    const RecentLeads = ({ setOpenForm, timeRange = "All Data", value }: RecentLeadsProps) => {
      ...
      return (
        <div className="bg-white p-6 sm:p-8 border border-gray-200 rounded-lg w-full flex flex-col h-[650px]">
          ...
          {/* Table Header */}
          <div className="flex items-center bg-gray-50 px-4 py-3 border-0 rounded-lg mb-2 text-gray-600 font-medium text-[13px] sm:text-[14px]">
            ...
            <div className="flex-[1.8] px-2 truncate">Lead Name</div>
          ...
          <div className="flex-1 overflow-y-auto no-scrollbar">
            {leadsData.map((row, index) => (
              <div
                key={index}
                className="flex items-center px-4 py-4 border-b border-gray-100 last:border-0 hover:bg-gray-50 text-[14px] sm:text-[15px] text-gray-900 transition-colors"
              >
